...
// sandbox as a separate entry that skips both. Ported verbatim from src/ui/Splash.jsx.
...
export type StartFn = (mode: 'dev' | 'new', size?: MapSizeKey, difficulty?: DifficultyKey) => void
